...
const SelectService = ({ handleServiceSelection }) => (
        ...
        <div className="basis-3/5">
            <div className="text-lg font-bold">Select a Service</div>
            {
                services.map((service) => (
                    <div className="flex justify-between border rounded-md items-center cursor-pointer shadow-cardshadow1 mt-8 p-4 hover:border-primary1"
                        key={service.name}
